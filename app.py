...
def main():
    ...
    options = ["Add Flavor", "View Flavors", "Delete Flavor", "Add Ingredient", "View Ingredients", "Delete Ingredient", "Add Suggestion", "View Suggestions", "Delete Suggestion"]
    ...
    # View Flavors
        ...
        for flavor in flavors:
            st.write(f"ID: {flavor[0]}, Name: {flavor[1]}, Seasonal: {'Yes' if flavor[2] else 'No'}")
    ...
    # View Suggestions
        ...
        for suggestion in suggestions:
            st.write(f"ID: {suggestion[0]}, Customer: {suggestion[1]}, Suggestion: {suggestion[2]}, Allergy Concern: {suggestion[3]}")
    ...
    # Delete Suggestion
        ...
        if st.button("Delete Suggestion"):
            ...
            st.success(f"Suggestion with ID '{suggestion_id}' deleted successfully!")
